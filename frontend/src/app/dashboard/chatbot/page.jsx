...
import { Send, Sparkles, Cpu, Bot, User } from 'lucide-react';
      ...
      <div className="glass-card rounded-xl flex flex-col h-[550px] border border-white/5 overflow-hidden">
        ...
        <div className="p-3 border-t border-white/5 bg-slate-900/20 flex gap-2 overflow-x-auto whitespace-nowrap scrollbar-none scroll-container">
          {SUGGESTIONS.map((s, idx) => (
            <button 
              ...
              className="px-2.5 py-1 bg-slate-900 border border-white/10 rounded-full text-[10px] font-bold text-gray-400 hover:text-white hover:border-blue-500/40 hover:bg-blue-950/10 transition-all flex items-center gap-1 cursor-pointer"
            >
              {s}
            </button>
          ))}
        ...
        >
          ...
          <button 
            ...
            className="p-2.5 bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 disabled:text-gray-500 text-white rounded-lg transition-all flex items-center justify-center shadow-glow-blue cursor-pointer"
          >
